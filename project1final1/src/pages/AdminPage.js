...
class AdminPage extends Component{
    ...
    render(){
        return (
            <Router>
                <div className="app header-fixed footer-fixed" style={{backgroundColor:'#1A1A1A',height:'1000px'}}>
                <div>
                    <header className="app-header navbar">
                    <AdminHeader/>
                    <button className="btn btn-light" onClick={this.logout} style={{position:'absolute',left:'46%',backgroundColor: '#1f1f42',color: '#ff0b0b',border: '1px solid #1f1f42'}}>LogOut</button>
                    </header>
